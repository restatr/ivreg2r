/*===========================================================================
  ...
  Deleted, not ported: card_partial_all (partial(_all) Stata parity is owned by M-04, generate-partial-all-fixtures.do, on mroz); card_partial_cluster cl/cl_small (cluster(smsa66) is the binary M=2 cluster anti-pattern on the spec-matrix delete table; cluster x partial lives at hf H28); the remaining card cells are replaced 1:1 by the griliches cells below.
