...
glance.ivreg2 <- function(x, ...) {
  ...
  tibble::tibble(
    ...
    overid_p           = overid_p,
    ar_overid_lr_stat  = .safe_diag(diag, "anderson_rubin_overid", "lr_stat"),
    ar_overid_lr_p     = .safe_diag(diag, "anderson_rubin_overid", "lr_p"),
    ar_overid_lin_stat = .safe_diag(diag, "anderson_rubin_overid", "lin_stat"),
    ar_overid_lin_p    = .safe_diag(diag, "anderson_rubin_overid", "lin_p"),
    ar_overid_df       = .safe_diag(diag, "anderson_rubin_overid", "df"),
