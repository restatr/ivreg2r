...
The Stock-Wright (2000) S statistic is a related weak-instrument-robust test
that is also automatically computed. See `vignette("advanced-iv")` for more on
...
| `"iid"` | `~ var` | `FALSE` | `ivreg2 ..., cluster(var)` |
...
These alternative estimators are less biased than 2SLS when instruments are
weak, at the cost of slightly larger variance. See `vignette("advanced-iv")`
...
See `vignette("advanced-iv")` for detailed examples of all advanced features.
