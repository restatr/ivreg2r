...
Source:
[`inst/CITATION`](https://github.com/restatr/ivreg2r/blob/main/inst/CITATION)

DiTraglia F (2026). *ivreg2r: Extended Instrumental Variables Estimation
with Diagnostics*. R package, <https://github.com/restatr/ivreg2r>.
